...
export const staticData: IstaticData[] = [
  {
    ...
    img: "https://lomusic2.s3.amazonaws.com/An_Orgel_of_Greatest_Memory.webp",
    details: {
      introduce:
        "이 프로젝트에서는 어쩌고 저쩌고를 한 모시깽이 저시깽이 입니다!",
      about: [
        {
          placeholder: "notion",
          link: "",
  ...
  },
  {
    title: "LoA Music",
    description:
      "팀 프로젝트를 진행하며 학습한 내용을 이용해서 스스로의 도메인으로 만드는 개인 프로젝트",
